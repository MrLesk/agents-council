...
Electrobun has a [built-in update mechanism](../../apis/updater.md) that optimizes updates for file-size and efficiency.
...
Using the [Electrobun Updater api](../../apis/updater.md) you can check for updates and automatically download, and install them. The flow looks something like:
...
[← Code Signing](../code-signing.md) [Webview Tag →](./webview-tag.md)
