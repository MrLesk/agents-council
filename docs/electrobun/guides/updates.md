...
-   [Update API](../apis/updater.md) to check for, download, and update your apps.
-   [CLI](../apis/cli/cli-args.md) to build your app bundle, codesign, and generate artifacts.
